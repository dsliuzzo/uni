...
public class BancoCheckInSemFIFO extends BancoCheckIn {
    private int nastro;
    private Semaphore mutex = new Semaphore(1);

    private Semaphore ingresso = new Semaphore(1,true);
    ...
    public void riceviCartaImbarco() throws InterruptedException {
        System.out.println("Cliente " + ((Passeggero) Thread.currentThread()).id() + " ha ricevuto la carta di imbarco");
    ...
    public static void main(String[] args) throws InterruptedException {
        BancoCheckInSemFIFO banco = new BancoCheckInSemFIFO();
        banco.test();
    }
}
