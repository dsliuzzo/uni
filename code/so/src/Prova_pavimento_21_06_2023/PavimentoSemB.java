package Prova_pavimento_21_06_2023;
...
public class PavimentoSemB extends Pavimento {
    ...
    private Semaphore inizio = new Semaphore(4);
    ...
    public PavimentoSemB(int nRighe, int nColonne) {
        this.nRighe = nRighe;
